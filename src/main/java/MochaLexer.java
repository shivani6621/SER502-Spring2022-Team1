...
public class MochaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "DATA_TYPE", "DATA_TYPE_INT", "DATA_TYPE_FLOAT", 
			"DATA_TYPE_BOOLEAN", "DATA_TYPE_STRING", "IDENTIFIER", "LITERAL", "INTEGER_LITERAL", 
			"FLOATING_POINT_LITERAL", "BOOLEAN_LITERAL", "STRING_LITERAL", "BOOLEAN_TRUE", 
			"BOOLEAN_FALSE", "WHITESPACE", "OP_ASSIGN", "OP_SET_ARITHMETIC", "OP_ADD", 
			"OP_SUB", "OP_MUL", "OP_DIV", "OP_SET_RELATIONAL", "OP_EQUALS", "OP_SMALLER", 
			"OP_GREATER", "OP_SMALLER_EQUALS", "OP_GREATER_EQUALS", "OP_SET_LOGICAL", 
			"OP_SET_LOGICAL_UNI", "OP_SET_LOGICAL_BIN", "OP_LOGICAL_AND", "OP_LOGICAL_OR", 
			"OP_LOGICAL_NOT", "OP_TERNARY_TRUE", "OP_TERNARY_FALSE"
		};
	}
